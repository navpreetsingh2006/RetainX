  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center p-12 text-center rounded-3xl border border-border bg-card shadow-sm h-[60vh] animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="h-20 w-20 bg-slate-500/10 rounded-3xl flex items-center justify-center mb-6 shadow-inner border border-slate-500/20">
          <Settings className="h-10 w-10 text-slate-600 dark:text-slate-400" />
        </div>
        <h2 className="text-2xl font-bold mb-3 tracking-tight">Account Settings</h2>
        <p className="text-muted-foreground max-w-md mx-auto leading-relaxed">
          Manage your team, billing, integrations, and notification preferences.
        </p>
      </div>
    </DashboardLayout>
  )
